...
@pytest.fixture
def mock_inputs():
    """Fixture to mock input prompts."""
    with patch('builtins.input', side_effect=["1", "2", "3"]) as _input:
        yield _input
